...
{
	CameraTab::DlgProcInit (hWnd, uMsg, wParam, lParam);
	TabTarget *pTab = (TabTarget*)(uMsg == WM_INITDIALOG ? lParam : GetWindowLong(hWnd,DWLP_USER));
...
{
	CameraTab::DlgProcInit (hWnd, uMsg, wParam, lParam);
	TabFov *pTab = (TabFov*)(uMsg == WM_INITDIALOG ? lParam : GetWindowLong(hWnd,DWLP_USER));
